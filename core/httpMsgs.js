...
exports.show413 = function(req,resp){
    if(settings.httpMsgsFormat === "HTML"){
        ...
        resp.write("<html><head><title>413</title></head><body>404: Request Entity Too Large</body></html>");
    }
    else{
...
exports.showHome = function (req, resp){
    if(settings.httpMsgsFormat === "HTML"){
        ...
        resp.write(JSON.stringify([
            ...
            {url: "/employee/<empno>", operation:"GET",description:"To List All Employees"},
        ]));
    }
    resp.end();
}